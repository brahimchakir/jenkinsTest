    ...
    stages { 
        ...
        stage('Push to Docker Hub') { 
            steps { 
                ...
                sh "docker tag my-python-app ${DOCKER_HUB_CREDENTIALS_USR}/atelier4_jenkins:latest"
        ...
        stage('Deploy') { 
            steps { 
                ...
                sh "'ssh user@remote-server "docker run -d -p 5000:5000 --name atelier4_jenkins ${DOCKER_HUB_CREDENTIALS_USR}/my-python-app:latest"' "
} 
}     }}